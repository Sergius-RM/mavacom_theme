...
register_nav_menus(
  [
    'menu-1' => esc_html__('Primary menu', 'miamilabs'),
    'serv-1' => esc_html__('Service menu', 'miamilabs'),
    'footer-1' => esc_html__('Footer menu', 'miamilabs'),
  ]
);

register_sidebar(array(
    'name'          => __('Service Header Widget Area', 'miamilabs'),
    'id'            => 'header_top',
    'description'   => __('Appears on posts and pages in the sidebar.', 'miamilabs'),
...
register_sidebar(array(
    'name'          => __('Header Widget Area', 'miamilabs'),
    'id'            => 'header_1',
    'description'   => __('Appears on posts and pages in the sidebar.', 'miamilabs'),
    'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    'after_widget'  => '</aside>',
...
register_sidebar(array(
    'name'          => __('Right Sidebar Area', 'miamilabs'),
    'id'            => 'sidebar_1',
    'description'   => __('Appears on posts and pages in the sidebar.', 'miamilabs'),
    'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    'after_widget'  => '</aside>',
...
register_sidebar(array(
    'name'          => __('Footer Widget Area', 'miamilabs'),
    'id'            => 'footer_1',
    'description'   => __('Appears on posts and pages in the sidebar.', 'miamilabs'),
    'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    'after_widget'  => '</aside>',
...
register_sidebar(array(
    'name'          => __('Footer Copyright Widget Area', 'miamilabs'),
    'id'            => 'footer_bottom',
    'description'   => __('Appears on posts and pages in the sidebar.', 'miamilabs'),
    'before_widget' => '<aside id="%1$s" class="widget %2$s">',
    'after_widget'  => '</aside>',
